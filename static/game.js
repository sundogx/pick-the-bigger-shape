...
var end_game = function() {
    ...
    $('#score').text(globals.score + "." + ((globals.score >= 5) ? " Congratulations! Your have correctly identified at least FIFTY shapes! You are a pick the bigger shape master. Now, one last question for you. At which number shape are concave polygons allowed to appear?" : ""));
